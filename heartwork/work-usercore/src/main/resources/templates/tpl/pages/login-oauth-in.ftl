      ...
      <div id="J_Static" class="login-box-switch static" style="display:none;"> 
       ...
       <form id="J_StaticForm" action="${contextPath}/login" method="post"> 
        ...
        <div class="field ph-hide"> 
         	...
         	<div class="input-group">
         		...
         		<input type="text" name="userName" id="J_UserName" title="<@spring.message  code="label.login.username.help" />" class="login-text required" placeholder='<@spring.message  code="label.login.username.help" />' value="" maxlength="32" tabindex="1" required/>
         	</div>
        </div> 
        <div class="field "> 
       ...
       <div class="clearfix" ></div>
	    <div class="login-sns" id="J_Login_sns" >
		 <ul class="login-sns"> 
		   <li class="weibo"> <a href="javascript:;"><i class="fa fa-weibo"></i></a> </li> 
		   <li class="qq"> <a href="javascript:;"><i class="fa fa-qq"></i></a> </li>
		    <li class="weixin"> <a href="javascript:;"><i class="fa fa-weixin"></i></a> </li>
		    <!---
		   <li class="github"> <a href="avascript:;"><i class="fa fa-github"></i></a> </li>
		   <li class="google"> <a href="javascript:;"><i class="fa fa-google"></i></a> </li>
		   <li class="renren"> <a href="javascript:;"><i class="fa fa-renren"></i></a> </li>  
...
<script>
  	seajs.use("js/login/login-oauth.js?v=${ver!'1'}.1");
</script> 
 </body>
</html>