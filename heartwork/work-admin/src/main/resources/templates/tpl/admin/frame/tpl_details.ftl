			...
			<div class="container-fluid" >
				...
				<div class="panel panel-primary">
					<div class="panel-heading" style="padding: 0px 15px;"  >
					  <a class="btn btn-danger" id="btn-reply" href="${contextPath}/admin/tpls.jhtml"> 
					...
					<div class="panel-body">
						<form class="form-horizontal " action="" id="J_articleForm"  method="post"  >
							 ...
							 <input type="hidden" class="form-control" id="tplType" value="${result.tplType}" name="tplType" />
							 <input type="hidden" class="form-control" id="tplCode" value="${result.tplCode}" name="tplCode" />
						 <div class="form-group" >
							...
							<div class="col-xs-5">
								<div class="input-group">
							  		...
							  		<p class="form-control form-control-static">${result.tplCode}</p>
						        </div>
							</div>
						 </div>
						 <div class="form-group" >
...
<script>
   	seajs.use(["js/left-menu.js?v=${ver!'1'}","/js/admin/frame/tpl_details.js?v="+Math.random(),"/js/app.js?v=${ver!'1'}"]);
</script>
 </body>
</html>