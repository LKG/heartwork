     ...
     <div  class="main-container-inner">
     	  ...
     	  <div class="main-content"> 
			...
			<div class="container-fluid" >
				 <#include "/admin/cms/friendlink_list_page.ftl" />
			</div>
     	  </div>
     </div>
    </div>
...
<script>
   	seajs.use(["js/left-menu.js?v=${ver!'1'}","/js/admin/cms/friendlink_list.js?v="+Math.random(),"/js/app.js?v=${ver!'1'}"]);
</script>
 </body>
</html>