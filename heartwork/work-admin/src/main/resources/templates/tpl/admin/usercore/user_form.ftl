	...
	<div class="full-container" id="main-container" style="height: 531px;">
		...
		<form class="form-horizontal" id="J_RegisterForm"  action="${contextPath}/admin/user/save" method="post" >
		  <div class="form-group">
		    <label for="userName" class="col-sm-1 col-xs-1 control-label"><sapn class="text-danger" >*</span><@spring.message  code="label.login.username" /></label>
		  ...
		  <div class="form-group">
		     <label for="userPhone" class="col-sm-1 col-xs-1 control-label"><sapn class="text-danger" >*</span><@spring.message  code="label.user.phone" /></label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group ">
		  ...
		  <!--
		  <div class="form-group">
		     <label for="password" class="col-sm-1 col-xs-1 control-label"><sapn class="text-danger" >*</span><@spring.message  code="label.login.password" /></label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
		   ...
		   <div class="form-group">
		     <label for="retryPassWord" class="col-sm-1 col-xs-1 control-label"><sapn class="text-danger" >*</span><@spring.message  code="label.user.password.confirm" /></label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
			      <div class="input-group-addon"><i class="fa fa-key"></i></div>
		 ...
		 <!----  
		  <div class="form-group">
		     <label for="phoneCode" class="col-sm-1 col-xs-1 control-label"><sapn class="text-danger" >*</span>短信码：</label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
		 ...
		 ----->
		  <div class="form-group">
		     <label for="nickName" class="col-sm-1 col-xs-1 control-label"><@spring.message  code="label.user.nickName" /></label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
		  ...
		  <div class="form-group">
		     <label for="userEmail" class="col-sm-1 col-xs-1 control-label"><@spring.message  code="label.user.email" /></label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
			      <div class="input-group-addon"><i class="fa fa-envelope-o"></i></div>
		...
		<div class="form-group hide">
		     <label for="userIdcard" class="col-sm-1 col-xs-1 control-label">身份证号</label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
		  ...
		  <div class="form-group">
		     <label for="realName" class="col-sm-1 col-xs-1 control-label">真实姓名</label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
			      <div class="input-group-addon"><i class="fa fa-credit-card"></i></div>
		   ...
		   <div class="form-group">
		     <label for="userQq" class="col-sm-1 col-xs-1 control-label"><@spring.message  code="label.user.qq" /></label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
