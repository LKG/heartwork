...
<link rel="stylesheet" type="text/css" href="${contextPath}/css/navbar-left-menu.css?v=${ver!'1'}" />
  ...
  .form-search select{
	...
	.operate i{
     ...
     <#assign template="monitor"/>
     <#assign submenu="logOperate"/> 
</head> 
     ...
     <div  class="main-container-inner">
     	  ...
     	  <div class="main-content"> 
			...
			<div class="container-fluid" >
			 <#include "/admin/usercore/log_operate_list_page.ftl" />	
			</div>
     	  </div>
     </div>
    </div>
...
<script>
   	seajs.use(["js/left-menu.js?v=${ver!'1'}","/js/admin/usercore/log_operate_list.js?v="+Math.random(),"/js/app.js?v=${ver!'1'}"]);
</script>
 </body>
</html>