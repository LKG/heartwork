							...
							<div class="col-xs-5">
								<div class="input-group">
									...
									<div class="input-group-addon">
						          	 <label><input type="checkbox" id="allowComment" name="allowComment" aria-label="允许评论" value="1"/>允许评论</label>
						          	</div>
						        </div>
							</div>
						 </div>
...
<script>
   	seajs.use(["js/left-menu.js?v=${ver!'1'}","/js/admin/cms/notice_create.js?v="+Math.random(),"/js/app.js?v=${ver!'1'}"]);
</script>
 </body>
</html>